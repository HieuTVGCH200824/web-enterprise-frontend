...
<div class="w-full">
    <a href="/{path}" class="{barState?" justify-start":"justify-center"}   max-md:justify-center p-4 flex rounded items-center hover:text-violet-400 sm:space-x-5 sm:h-10 hover:bg-black/50">
        ...
        <p class="{barState?"visibile opacity-100 translate-x-0 text-base" : "absolute w-0 h-0 invisible opacity-0 -translate-x-10"} ease-in-out duration-500 max-md:invisible ">
            {content}
        </p>
    </a>
</div>