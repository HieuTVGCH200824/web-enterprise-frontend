...
<button type="submit" on:click={handleEvent} class="hover:bg-green-600 hover:scale-105 duration-500 bg-green-400 rounded p-2 flex flex-row items-center justify-center space-x-2">
